...
function CreateDeal({ onClose, onCreate, pipelines = [] }) {
  ...
  const handleChange = (e) => {
    ...
    setForm((current) => ({
      ...
      // Pipeline change hone par stage reset
      ...(name === "pipeline_id"
        ? { deal_stage: "" }
        : {}),
    }));
  ...
  const selectedPipeline = pipelines.find(
    (pipeline) =>
      pipeline.pipeline_id === form.pipeline_id
  );
  ...
  const handleSubmit = (e) => {
    ...
    const dealData = {
      ...
      deal_organization:
        form.deal_organization.trim() || null,

      customer_email:
        form.customer_email.trim() || null,

      deal_owner:
        form.deal_owner.trim() || null,
      ...
      customer_number:
        form.customer_number.trim() || null,

      customer_address:
        form.customer_address.trim() || null,

      deal_notes:
        form.deal_notes.trim() || null,
    };
